                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="top-card" style="padding: 20px; margin-bottom: 20px; text-align: center;">
                            <a href="/velvetandvine/catalog/product?pid=<?php echo urlencode($accessory->productID); ?>" style="text-decoration: none; color: inherit;">
                                <img src="/velvetandvine/images/products/product_<?php echo $accessory->productID ?>.jpg" onerror="this.onerror=null;this.src='/velvetandvine/images/no-image.jpg';" alt="<?php echo htmlspecialchars($accessory->name); ?>" style="width: 300px; height: 300px; object-fit: cover; margin-bottom: 10px;">
