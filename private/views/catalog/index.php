                                ...
                                <div class="product-card col-md-3 col-sm-4 mb-3" style="min-width: 200px;">
                                    <div class="top-card" style="padding: 20px; text-align: center;">
                                        ...
                                        <a href="/velvetandvine/catalog/product?pid=<?php echo urlencode($product['ProductID']); ?>" style="text-decoration: none; color: inherit;">
                                            <img src="/velvetandvine/public/images/products/product_<?php echo $product['ProductID'] ?>.jpg" onerror="this.onerror=null;this.src='/velvetandvine/public/images/no-image.jpg';" alt="<?php echo htmlspecialchars($product['product_name'] ?? 'No Name'); ?>" style="width: 250px; height: 250px; object-fit: cover; margin-bottom: 10px;">
